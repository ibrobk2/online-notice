...
<script src="js/bootstrap.min.js"></script>
	...
	<body>
			<nav class="navbar navbar-dark navbar-fixed-top" style="background-color: #000;">
  <div class="container">

  <ul class="nav navbar-nav navbar-left">

    <li><a href="index.php" class="navl-link text-white" style="color: #fff;"><strong>Online Notice Board</strong></a></li>
	<?php
	if (isset($_SESSION['admin'])):
	?>
	<li><a href="./admin" class="navl-link text-white" style="color: #fff;"><span class="glyphicon glyphicon-user"></span>Admin Dashboard</a></li>
	<li><a href="./admin/logout" class="navl-link text-white" style="color: #fff;"><span class="glyphicon glyphicon-lock"></span>Logout</a></li>
	<?php else:?>
	<li><a href="user_auth" class="navl-link text-white" style="color: #fff;"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
	<!-- <li><a href="index.php?option=New_user"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li> -->
	<li><a href="index.php?option=login" class="navl-link text-white" style="color: #fff;"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
	<?php  endif; ?>
	</ul>
...
<!-- footer-->
  ...
  <ul class="nav navbar-nav navbar-left">
    <li><a href="#"> Copyright:2024 Department of Software Engineering BUK Kano</a></li>
