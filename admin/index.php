  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<li><a href="index.php?page=add_notice"><span class="glyphicon glyphicon-plus"></span>Add New Notice</a></li>
      <li><a href="index.php?page=notification"><span class="glyphicon glyphicon-envelope"></span> Mange  Notification</a></li>
            ...
            <li><a href="../index.php?option=New_user"><span class="glyphicon glyphicon-plus"></span> Add Student</a></li>
